<script>
    ...
    const code = [{
        ...
        },
        {
            ...
            desc: "Open source Node package for the OS Data Hub",
    ...
    const blogs = [
        ...
        {
            title: "Get Pret Go",
            desc: "How to walk through London always with a coffee in your hand",
        ...
        },
        {
            ...
            image: "plaque.png",
            alt: "Blue Plaque of Alan Turing"
        },
        {
